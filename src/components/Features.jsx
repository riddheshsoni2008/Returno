export default function Features() {
  ...
  const industries = [
    { name: "Cafes", desc: "Buy 9 coffees, get 10th free.", icon: "☕" },
    { name: "Restaurants", desc: "Claim free appetizers or desserts.", icon: "🍔" },
    { name: "Salons & Spas", desc: "Unlock 50% off on your 5th haircut.", icon: "💇‍♀️" },
    { name: "Gyms & Fitness", desc: "Earn free sessions and health shakes.", icon: "🏋️‍♂️" },
    { name: "Clinics", desc: "Reward regular routine health checks.", icon: "🩺" },
    { name: "Retail Stores", desc: "Provide exclusive percentage cashbacks.", icon: "🛍️" }
  ];
