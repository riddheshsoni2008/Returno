...
export default function Hero() {
 ...
 <h1 className="text-5xl md:text-7xl font-black tracking-tight mb-8 leading-[1.15] text-text-primary scroll-reveal">
 ...
 <strong className="text-text-primary font-extrabold block mt-2">Simple, secure, and cardless.</strong>
 </p>
 ...
 <a href="#how-it-works" className="px-8 py-4 rounded-2xl bg-white border border-border-standard text-slate-700 font-extrabold text-lg hover:border-slate-350 hover:bg-slate-50/80 transition-all duration-300 shadow-sm w-full sm:w-auto flex items-center justify-center">
 Watch Demo
 </a>
 </div>
 ...
 <div className="rounded-2xl border border-border-standard bg-white shadow-[0_20px_50px_-12px_rgba(0,0,0,0.1)] p-2 sm:p-4 relative">
 <div className="rounded-xl overflow-hidden bg-slate-50 border border-border-standard aspect-auto sm:aspect-[16/10] flex flex-col relative shadow-inner">
 
 {/* Mockup Header */}
 <div className="h-14 border-b border-border-standard bg-white flex items-center px-6 justify-between">
 ...
 <div className="h-10 bg-white border border-border-standard rounded-lg w-full"></div>
 <div className="h-10 bg-white border border-border-standard rounded-lg w-full"></div>
 </div>
 ...
 <div className="bg-white p-4 sm:p-6 rounded-xl border border-border-standard shadow-sm flex flex-col">
 <span className="text-sm font-medium text-text-secondary mb-2">Total Scans</span>
 <span className="text-2xl sm:text-3xl font-bold text-text-primary">1,248</span>
 </div>
 <div className="bg-white p-4 sm:p-6 rounded-xl border border-border-standard shadow-sm flex flex-col">
 <span className="text-sm font-medium text-text-secondary mb-2">Active Members</span>
 <span className="text-2xl sm:text-3xl font-bold text-text-primary">492</span>
 </div>
 ...
 <div className="flex-1 bg-white border border-border-standard rounded-xl p-6 shadow-sm">
 ...
 <div className="h-10 w-10 bg-slate-100 rounded-full flex items-center justify-center text-text-muted">
 ...
 <div className="mt-24 border-t border-border-standard pt-16 max-w-4xl mx-auto grid grid-cols-1 sm:grid-cols-3 gap-8 text-center scroll-fade">
 <div className="p-6">
 <div className="flex items-center justify-center w-12 h-12 rounded-full bg-blue-50 text-blue-600 mx-auto mb-4">
 <Users className="w-6 h-6" />
 </div>
 <div className="text-4xl font-extrabold text-text-primary">500+</div>
 <div className="text-sm text-text-secondary mt-2 font-medium">Businesses Onboarded</div>
 </div>
 <div className="p-6">
 <div className="flex items-center justify-center w-12 h-12 rounded-full bg-purple-50 text-purple-600 mx-auto mb-4">
 <ScanLine className="w-6 h-6" />
 </div>
 <div className="text-4xl font-extrabold text-text-primary">1M+</div>
 <div className="text-sm text-text-secondary mt-2 font-medium">Scans & Visits Logged</div>
 </div>
 <div className="p-6">
 <div className="flex items-center justify-center w-12 h-12 rounded-full bg-amber-50 text-amber-600 mx-auto mb-4">
 <Gift className="w-6 h-6" />
 </div>
 <div className="text-4xl font-extrabold text-text-primary">50K+</div>
 <div className="text-sm text-text-secondary mt-2 font-medium">Rewards Handed Out</div>
 </div>
 </div>
 </div>
 </section>
