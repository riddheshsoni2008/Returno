    ...
    <section id="how-it-works" className="py-24 relative bg-white border-t border-slate-200">
      <div className="container mx-auto px-6">
        <div className="text-center mb-16 scroll-reveal">
          <h2 className="text-3xl md:text-5xl font-bold mb-4 text-slate-900">How Returno Works</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {steps.map((step, index) => (
            ...
            >
              ...
              <h3 className="text-xl font-bold mb-3 text-slate-900 group-hover:text-brand-600 transition-colors relative z-10">{step.title}</h3>
