...
export default function JoinClient({ campaign, business, user }) {
 ...
 <div className="w-16 h-16 rounded-2xl bg-gradient-to-tr from-red-600 to-rose-600 flex items-center justify-center font-black text-2xl mx-auto shadow-lg shadow-red-500/20 border border-border-standard mb-4 text-white">
 {business.name?.[0]?.toUpperCase() || '?'}
 </div>
 <span className="inline-block text-[9px] uppercase tracking-widest font-extrabold px-2.5 py-1 rounded-full bg-slate-100 border border-slate-200/50 text-text-secondary mb-2">
 {business.category || 'Retail'}
 </span>
 <h1 className="text-xl font-black text-text-primary leading-tight">{business.name}</h1>
 <p className="text-xs text-text-secondary mt-1">📍 {business.address || business.city || 'Local Business'}</p>
 </div>
 ...
 <h2 className="text-md font-bold text-text-primary pt-1.5">{campaign.title}</h2>
 <p className="text-xs text-slate-650 leading-relaxed">{campaign.description}</p>
 </div>

 {/* Reward highlights */}
 <div className="flex items-center gap-3 bg-white border border-border-standard rounded-2xl p-3 shadow-sm">
 <span className="text-2xl">🎁</span>
 <div>
 <div className="text-[9px] text-text-muted font-bold uppercase tracking-wider">Redeemable Reward</div>
 ...
 <div className="bg-white rounded-xl p-2.5 border border-border-standard shadow-sm">
 <div className="text-md font-black text-red-600">+{campaign.pointsPerCheckin || 10}</div>
 <div className="text-[9px] text-text-secondary font-bold uppercase tracking-wide">Points</div>
 </div>
 <div className="bg-white rounded-xl p-2.5 border border-border-standard shadow-sm">
 ...
 <div className="bg-white rounded-xl p-2.5 border border-border-standard shadow-sm">
 <div className="text-md font-black text-text-primary">{campaign.requiredStamps}</div>
 ...
 <div className="space-y-5 text-center border-t border-border-standard pt-5 animate-[fade-in_0.4s_ease-out]">
 <div className="space-y-2">
 <div className="text-5xl animate-bounce">🎉</div>
 <h3 className="text-lg font-black text-text-primary">Successfully Enrolled!</h3>
 <p className="text-xs text-text-secondary">
 ...
 <div className="text-[10px] text-text-muted font-bold uppercase tracking-wider">How to earn rewards</div>
 ...
 <Link 
 href="/" 
 className="w-full py-2.5 bg-slate-100 hover:bg-slate-200 text-slate-650 font-bold text-xs rounded-xl transition-all border border-border-standard text-center"
 >
 Back to Home
 </Link>
 </div>
