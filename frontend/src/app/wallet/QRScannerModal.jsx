...
export default function QRScannerModal({ onClose }) {
  ...
  return (
    <div className="fixed inset-0 bg-slate-50/95 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="bg-white border border-slate-200 w-full max-w-sm rounded-[2rem] p-6 shadow-xl relative overflow-hidden text-center space-y-4">
        ...
        <div className="mx-auto overflow-hidden rounded-2xl border-4 border-slate-100 shadow-sm" style={{ width: '100%', maxWidth: '300px' }}>
