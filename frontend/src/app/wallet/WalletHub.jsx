...
const ThreeDStar = ({ filled, className = "" }) => {
  ...
  return (
    ...
    >
      ...
      <path
        d="M12 2 L14.2 8.9 L21.5 8.9 L15.6 13.2 L17.9 20.1 L12 15.8 L6.1 20.1 L8.4 13.2 L2.5 8.9 L9.8 8.9 Z"
        fill="url(#goldHighlightWallet)"
        opacity="0.4"
      />
    </svg>
  );
