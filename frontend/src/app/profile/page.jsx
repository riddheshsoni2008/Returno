    ...
    <main className="min-h-screen bg-dark-950 text-white py-12 px-6 flex flex-col justify-between relative overflow-hidden">
      ...
      <div className="max-w-md w-full mx-auto space-y-8 my-auto z-10">
        ...
        <div className="flex justify-between items-center">
          <Link href="/wallet" className="text-xs font-semibold text-slate-400 hover:text-white transition-colors bg-white/5 border border-white/10 rounded-full px-4 py-2">
            ← Back to Wallet
          </Link>
        ...
        <div className="bg-dark-900/60 border border-white/10 rounded-3xl p-6 sm:p-8 backdrop-blur-3xl shadow-2xl space-y-6">
          ...
          <div className="border-t border-white/5 pt-6 space-y-4">
            ...
            <div className="space-y-1">
              <span className="text-[10px] text-slate-500 font-bold uppercase tracking-wider block">Joined Platform</span>
          ...
          <div className="grid grid-cols-2 gap-4 border-t border-white/5 pt-6">
            <div className="bg-white/5 border border-white/5 p-4 rounded-xl text-center">
              <span className="text-[10px] text-slate-400 font-bold uppercase tracking-wider block mb-1">Rewards Won</span>
              <span className="text-2xl font-black text-brand-400">{rewardsCount}</span>
            </div>
            <div className="bg-white/5 border border-white/5 p-4 rounded-xl text-center">
              <span className="text-[10px] text-slate-400 font-bold uppercase tracking-wider block mb-1">Tier Level</span>
